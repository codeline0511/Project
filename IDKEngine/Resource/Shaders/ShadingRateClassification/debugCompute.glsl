...
void main()
{
    ...
    {
        float frequencyValue = texture(SamplerDebugOtherData, scaledUv).r;

        // 0 = high detail, 0.5 = medium, 1.0 = low detail
        // high detail이 더 잘 보이도록 반전
        debugColor = vec3(1.0 - frequencyValue);
    }
